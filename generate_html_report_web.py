...
OUT_PATH = ROOT / "Webpage_Accessibility_Audit_Report.html"
...
parts.append("  <title>Recipe Dashboard | Accessibility Audit Report</title>")
parts.append("  <style>")
...
parts.append("    <h1>Recipe Dashboard - Accessibility Audit Report</h1>")
parts.append('    <section class="report-details" aria-label="Testing details">')
parts.append('      <p><strong>Page URL:</strong> <a href="https://broken-workshop.dequelabs.com/" target="_blank" rel="noopener noreferrer">https://broken-workshop.dequelabs.com/</a></p>')
parts.append('      <p><strong>Scope Of Testing:</strong> Dashboard Page, Cook (recipe) dialog, and Edit recipe dialog</p>')
parts.append('      <p><strong>Accessibility Testing Standard:</strong> WCAG 2.2 Level AA</p>')
parts.append('      <p><strong>Digital asset type:</strong> Webpage</p>')
parts.append('      <p><strong>Assistive technology:</strong> VoiceOver (macOS)</p>')
parts.append('      <p><strong>Browser:</strong> Safari V26.2</p>')
...
for impact in IMPACT_ORDER:
    ...
    if not issues:
        ...
        for idx, issue in enumerate(issues, start=1):
            ...
            parts.append(
                f'          <div class="issue-number" role="heading" aria-level="3"><span class="sr-only">{esc(impact)} </span>Issue {idx}</div>'
            )
